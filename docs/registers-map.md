# JSD Solar 3KU — Повна карта Modbus регістрів

> **Джерело:** `INV-Modbus地址表3KU（外发）V1.20.xlsx`  
> **Тип:** Holding Registers, Function Code 03  
> **Адреси:** 0-based hex (поле `address:` в ESPHome)  
>
...
1. [Версії документа](#version-information)
2. [Формат комунікації](#communication-format)
3. [Регістри](#register-sheets)
...
**Параметри порту:** 9600 bps, 8N1 (8 data bits, No parity, 1 stop bit)

### Запит (Function Code 0x03 / 0x10)

| Поле | Slave Addr | Func Code | Addr High | Addr Low | Reg Count High | Reg Count Low | CRC Low | CRC High |
|------|-----------|-----------|-----------|----------|---------------|--------------|---------|----------|
| Байти | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 1 |

### Доступні Function Codes

| Код | Опис |
|-----|------|
| 0x03 | Читання Holding Registers (Read) |
| 0x10 | Запис Holding Registers (Write) |
...
| ✅ | ✅ | ✅ | `0x0001` | 1 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0002` | 2 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0003` | 3 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0004` | 4 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0005` | 5 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0006` | 6 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0007` | 7 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0008` | 8 | SN code | uint16_t |  | Reading and writing |  |
| ✅ | ✅ | ✅ | `0x0009` | 9 | SN code | uint16_t |  | Reading and writing |  |
...
| ✅ | ✅ | ✅ | `0x0010` | 16 | Protocol version_H | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0011` | 17 | Protocol version_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0012` | 18 | Power board hardware version_H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0013` | 19 | Power board hardware version_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0014` | 20 | Control board hardware version_H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0015` | 21 | Control board hardware version_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0016` | 22 | Centralized control version hardware version H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0017` | 23 | Centralized control version hardware version L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0018` | 24 | Power board software version_H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0019` | 25 | Power board software version_L | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x001A` | 26 | Control board software version_H | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x001B` | 27 | Control board software version_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x001C` | 28 | Centralized control software version H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x001D` | 29 | Centralized control software version L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x001E` | 30 | Version Time_H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x001F` | 31 | Version Time_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0020` | 32 | CheckSum_H | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0021` | 33 | CheckSum_L | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0022` | 34 | PC communication protocol version | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0023` | 35 | WiFi communication protocol version | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0024` | 36 | BMS communication protocol version | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0025` | 37 | Parallel communication protocol version | uint16_t |  | Read-only |  |
| ✅ |  |  | `0x0026` | 38 |  |  |  |  |  |
| ✅ |  |  | `0x0027` | 39 |  |  |  |  |  |
| ✅ |  |  | `0x0028` | 40 |  |  |  |  |  |
| ✅ |  |  | `0x0029` | 41 |  |  |  |  |  |
...
| ✅ |  |  | `0x0036` | 54 |  |  |  |  |  |
| ✅ |  |  | `0x0037` | 55 |  |  |  |  |  |
| ✅ |  | ✅ | `0x0038` | 56 | Protocol Identifier_A | uint16_t |  | Read-only | Compatible Customers: 0x00: Reference Design 0x01: Reserved |
| ✅ | ✅ | ✅ | `0x0039` | 57 | Protocol Identifier_B | uint16_t |  | Read-only | Compatible models: 0x00: 6.5K 0x10: 6KU 0x20: 5KU |
| ✅ |  | ✅ | `0x003A` | 58 | Protocol Identifier_C |  |  | Read-only |  |
| ✅ |  | ✅ | `0x003B` | 59 | Protocol Identifier_D |  |  | Read-only |  |
| ✅ |  | ✅ | `0x003C` | 60 | Device Type_H |  |  | Read-only |  |
| ✅ |  | ✅ | `0x003D` | 61 | Equipment type_L |  |  | Read-only |  |
| ✅ |  | ✅ | `0x003E` | 62 | Company Information_H |  |  | Read-only |  |
| ✅ |  | ✅ | `0x003F` | 63 | Company Information_L |  |  | Read-only |  |
...
| ✅ |  | ✅ | `0x0041` | 65 | BMS connection status | uint16_t |  | Read-only | 0: ID search in progress; 1: ID locked - CAN; 2: ID locked - serial port; 3: ID remotely locked. |
| ✅ |  | ✅ | `0x0042` | 66 | State machine states | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0043` | 67 | Energy terminal status | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0044` | 68 | Energy flow state | uint16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0045` | 69 | Parallel operation | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0046` | 70 | Fault Code 1 | uint16_t |  | Read-only | BIT00: Mains soft start failure BIT01: Bus overvoltage BIT02: Bus undervoltage BIT03: Battery overcurrent BIT04: Overtemperatur... |
| ✅ | ✅ | ✅ | `0x0047` | 71 | Fault Code 2 | uint16_t |  | Read-only | BIT00: Programming in progress BIT01: Photovoltaic reverse connection BIT02: Parallel serial number abnormal BIT03: Parallel co... |
| ✅ | ✅ | ✅ | `0x0048` | 72 | Alarm code 1 | uint16_t |  | Read-only | BIT00: Battery not connected BIT01: Battery undervoltage BIT02: Battery low voltage BIT03: Charger short circuit BIT04: Reserve... |
| ✅ | ✅ | ✅ | `0x0049` | 73 | Alarm code 2 | uint16_t |  | Read-only | BIT00: Parallel communication error BIT01: Excessive voltage difference or frequency in parallel operation BIT02: Low SOC shutd... |
| ✅ |  |  | `0x004A` | 74 |  |  |  |  |  |
| ✅ |  |  | `0x004B` | 75 |  |  |  |  |  |
| ✅ |  |  | `0x004C` | 76 |  |  |  |  |  |
| ✅ |  |  | `0x004D` | 77 |  |  |  |  |  |
| ✅ |  |  | `0x004E` | 78 |  |  |  |  |  |
| ✅ |  |  | `0x004F` | 79 |  |  |  |  |  |
| ✅ | ✅ | ✅ | `0x0050` | 80 | Phase A mains voltage | int16_t | 0.1V | Read-only |  |
| ✅ | ✅ | ✅ | `0x0051` | 81 | Phase A mains current | int16_t | 0.01A | Read-only |  |
| ✅ | ✅ | ✅ | `0x0052` | 82 | Phase A mains frequency | int16_t | 0.01Hz | Read-only |  |
| ✅ | ✅ | ✅ | `0x0053` | 83 | Phase A mains power | int16_t | 1W | Read-only |  |
| ✅ | ✅ | ✅ | `0x0058` | 88 | Phase A load voltage | int16_t | 0.1V | Read-only |  |
| ✅ | ✅ | ✅ | `0x0059` | 89 | Phase A load current | int16_t | 0.01A | Read-only |  |
| ✅ | ✅ | ✅ | `0x005A` | 90 | Phase A load frequency | int16_t | 0.01Hz | Read-only |  |
| ✅ | ✅ | ✅ | `0x005B` | 91 | Phase A load active power | int16_t | 1W | Read-only |  |
| ✅ | ✅ | ✅ | `0x005C` | 92 | Apparent power of phase A load | int16_t | 1W | Read-only |  |
| ✅ | ✅ | ✅ | `0x005D` | 93 | Phase A load percentage | int16_t | 0.1% | Read-only |  |
| ✅ |  |  | `0x005E` | 94 |  |  |  |  |  |
| ✅ |  |  | `0x005F` | 95 |  |  |  |  |  |
...
| ✅ |  |  | `0x007E` | 126 |  |  |  |  |  |
| ✅ |  |  | `0x007F` | 127 |  |  |  |  |  |
| ✅ | ✅ | ✅ | `0x0080` | 128 | Positive terminal battery voltage | int16_t | 0.1V | Read-only |  |
| ✅ | ✅ | ✅ | `0x0081` | 129 | Positive terminal battery current | int16_t | 0.1A | Read-only |  |
| ✅ |  | ✅ | `0x0082` | 130 | Negative battery voltage | int16_t | 0.1V | Read-only |  |
| ✅ |  | ✅ | `0x0083` | 131 | Negative battery current | int16_t | 0.1A | Read-only |  |
| ✅ | ✅ | ✅ | `0x0084` | 132 | Battery capacity percentage | int16_t | 0.1% | Read-only |  |
| ✅ | ✅ | ✅ | `0x0085` | 133 | Battery power | int16_t | 1W | Read-only |  |
| ✅ |  |  | `0x0086` | 134 |  |  |  |  |  |
| ✅ |  |  | `0x0087` | 135 |  |  |  |  |  |
| ✅ |  | ✅ | `0x0088` | 136 | BMS Battery Voltage | int16_t | 0.1V | Read-only |  |
| ✅ |  | ✅ | `0x0089` | 137 | BMS Battery Current | int16_t | 0.1A | Read-only |  |
| ✅ |  | ✅ | `0x008A` | 138 | BMS SOC | int16_t | % | Read-only |  |
| ✅ |  | ✅ | `0x008B` | 139 | BMS Temperature | int16_t | ℃ | Read-only |  |
| ✅ |  | ✅ | `0x008C` | 140 | BMS constant pressure point (CV point) | uint16_t | 0.1V | Read-only |  |
| ✅ |  | ✅ | `0x008D` | 141 | Rated capacity | uint16_t | 100mAH | Read-only |  |
| ✅ |  | ✅ | `0x008E` | 142 | Current capacity | uint16_t | 100mAH | Read-only |  |
| ✅ | ✅ | ✅ | `0x008F` | 143 | BMS communication status | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0090` | 144 | Lithium battery network status | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0091` | 145 | BMS failure | uint16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0092` | 146 | BMS Alarms | uint16_t |  | Read-only |  |
| ✅ |  |  | `0x0093` | 147 |  |  |  |  |  |
| ✅ |  |  | `0x0094` | 148 |  |  |  |  |  |
| ✅ |  |  | `0x0095` | 149 |  |  |  |  |  |
| ✅ | ✅ | ✅ | `0x0096` | 150 | Photovoltaic voltage 1 | int16_t | 0.1V | Read-only |  |
| ✅ | ✅ | ✅ | `0x0097` | 151 | Photovoltaic 1 current | int16_t | 0.01A | Read-only |  |
| ✅ | ✅ | ✅ | `0x0098` | 152 | Photovoltaic power | int16_t | 1W | Read-only |  |
| ✅ | ✅ | ✅ | `0x0099` | 153 | Photovoltaic 2 voltage | int16_t | 0.1V | Read-only |  |
| ✅ | ✅ | ✅ | `0x009A` | 154 | Photovoltaic 2 Current | int16_t | 0.01A | Read-only |  |
| ✅ | ✅ | ✅ | `0x009B` | 155 | Photovoltaic 2 power | int16_t | 1W | Read-only |  |
| ✅ |  | ✅ | `0x009C` | 156 | Photovoltaic power generation on that day | uint16_t | 100Wh | Read-only |  |
| ✅ |  | ✅ | `0x009D` | 157 | Total photovoltaic power generation | uint16_t | 100Wh | Read-only |  |
|  |  |  | `0x009E` | 158 |  |  |  |  |  |
|  |  |  | `0x009F` | 159 |  |  |  |  |  |
...
| ✅ |  | ✅ | `0x01B1` | 433 | Phase A mains current | int16_t | 0.01A | Read-only |  |
| ✅ |  | ✅ | `0x01B2` | 434 | Phase A mains frequency | int16_t | 0.01Hz | Read-only |  |
| ✅ |  | ✅ | `0x01B3` | 435 | Phase A mains power | int16_t | 10W | Read-only |  |
| ✅ |  | ✅ | `0x01B4` | 436 | Phase A AC power (electricity consumption only) | int16_t | 10W | Read-only |  |
| ✅ |  |  | `0x01B5` | 437 |  |  |  |  |  |
| ✅ |  |  | `0x01B6` | 438 |  |  |  |  |  |
| ✅ |  | ✅ | `0x01B7` | 439 | A. Equivalent daily municipal power grid supply H | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01B8` | 440 | A. Equivalent daily municipal power grid total L | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01B9` | 441 | A is equivalent to the total monthly municipal power grid supply H | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01BA` | 442 | A is equivalent to the total monthly power grid supply L | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01BB` | 443 | A is equivalent to the total annual municipal power grid supply H | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01BC` | 444 | A is equivalent to the total amount of municipal power grid feeder in a given year. | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01BD` | 445 | The total power supply to the mains grid in phase A is H | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x01BE` | 446 | Total A-phase mains power supply L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01BF` | 447 | A. Equivalent daily electricity consumption H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C0` | 448 | A is equivalent to the total daily electricity consumption L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C1` | 449 | A is equivalent to H, the total monthly electricity consumption. | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C2` | 450 | A is equivalent to the total monthly electricity consumption L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C3` | 451 | A. Equivalent annual total municipal electricity consumption H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C4` | 452 | A is equivalent to the total annual electricity consumption of the municipality. | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C5` | 453 | Total electricity consumption of phase A by the mains H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x01C6` | 454 | Total electricity consumption of phase A (L) | uint16_t | 10Wh | Read-only |  |
| ✅ |  |  | `0x01C7` | 455 |  |  |  |  |  |
| ✅ |  |  | `0x01C8` | 456 |  |  |  |  |  |
| ✅ |  |  | `0x01C9` | 457 |  |  |  |  |  |
| ✅ |  |  | `0x01CA` | 458 |  |  |  |  |  |
...
| Initial Loger query | Regular Loger query | ✅ | Hex | Dec | Назва | Тип | Одиниця | Дозвіл | Примітки |
|---|---|----|-----|-----|-------|-----|---------|--------|----------|
| ✅ |  | ✅ | `0x0210` | 528 | Output debug address set |  |  |  |  |
| ✅ |  | ✅ | `0x0210` | 528 | Output priority | uint16_t |  | Read-only | 0:GPB 1:PGB 2:PBG 3:MKS |
| ✅ |  | ✅ | `0x0211` | 529 | Operating mode | uint16_t |  | Read-only | 0:APP 1:UPS 2:GEN |
| ✅ |  |  | `0x0212` | 530 |  |  |  |  |  |
| ✅ |  |  | `0x0213` | 531 |  |  |  |  |  |
| ✅ |  |  | `0x0214` | 532 |  |  |  |  |  |
| ✅ |  |  | `0x0215` | 533 |  |  |  |  |  |
| ✅ |  |  | `0x0216` | 534 |  |  |  |  |  |
| ✅ |  |  | `0x0217` | 535 |  |  |  |  |  |
| ✅ |  | ✅ | `0x0218` | 536 | A-phase output voltage | int16_t | 0.1V | Read-only |  |
| ✅ |  | ✅ | `0x0219` | 537 | Phase A output frequency | int16_t | 0.01Hz | Read-only |  |
| ✅ |  | ✅ | `0x021A` | 538 | Phase A output current | int16_t | 0.01A | Read-only |  |
| ✅ |  |  | `0x021B` | 539 | Phase A outputs a small current. | int16_t | 0.01A | Read-only | reserve |
| ✅ |  | ✅ | `0x021C` | 540 | Phase A output active power | int16_t | 1W | Read-only |  |
| ✅ |  | ✅ | `0x021D` | 541 | Apparent power output of phase A | int16_t | 1W | Read-only |  |
| ✅ |  |  | `0x021E` | 542 |  |  |  |  |  |
| ✅ |  |  | `0x021F` | 543 |  |  |  |  |  |
| ✅ |  | ✅ | `0x0220` | 544 | Phase A load percentage | int16_t | 0.1% | Read-only |  |
| ✅ | ✅ | ✅ | `0x0221` | 545 | A equivalent daily output power H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0222` | 546 | A equivalent daily output power L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0223` | 547 | A is equivalent to monthly output power H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0224` | 548 | A is equivalent to monthly power output L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0225` | 549 | A equivalent annual power output H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0226` | 550 | A equivalent annual power output L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0227` | 551 | Phase A total output power H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0228` | 552 | Phase A total output power L | uint16_t | 10Wh | Read-only |  |
| ✅ |  |  | `0x0229` | 553 |  |  |  |  |  |
| ✅ |  |  | `0x022A` | 554 |  |  |  |  |  |
| ✅ |  |  | `0x022B` | 555 |  |  |  |  |  |
| ✅ |  |  | `0x022C` | 556 |  |  |  |  |  |
...
| ✅ |  | ✅ | `0x0261` | 609 | Total photovoltaic current H | int16_t | 0.01A | Read-only |  |
| ✅ |  | ✅ | `0x0262` | 610 | Total photovoltaic current L | int16_t | 0.01A | Read-only |  |
| ✅ |  | ✅ | `0x0263` | 611 | Total photovoltaic power H | int16_t | 1W | Read-only |  |
| ✅ |  | ✅ | `0x0264` | 612 | Total photovoltaic power L | int16_t | 1W | Read-only |  |
| ✅ |  | ✅ | `0x0265` | 613 | Total Solar Tracking Status | int16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0266` | 614 | Total state of solar power rechargeability | int16_t |  | Read-only |  |
| ✅ | ✅ | ✅ | `0x0267` | 615 | Total photovoltaic power generation H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0268` | 616 | Total photovoltaic power generation L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x0269` | 617 | Total photovoltaic power generation H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x026A` | 618 | Total photovoltaic power generation L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x026B` | 619 | Total photovoltaic power generation H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x026C` | 620 | Total photovoltaic power generation L | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x026D` | 621 | Total photovoltaic power generation H | uint16_t | 10Wh | Read-only |  |
| ✅ | ✅ | ✅ | `0x026E` | 622 | Total photovoltaic power generation L | uint16_t | 10Wh | Read-only |  |
| ✅ |  |  | `0x026F` | 623 |  |  |  |  |  |
...
| ✅ |  | ✅ | `0x0273` | 627 | Photovoltaic 1 tracking status | int16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0274` | 628 | Photovoltaic 1 Rechargeable State | int16_t |  | Read-only |  |
| ✅ |  | ✅ | `0x0275` | 629 | Photovoltaic power generation H on the day | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x0276` | 630 | Photovoltaic power generation L on the day | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x0277` | 631 | Photovoltaic power generation H in the current month | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x0278` | 632 | Photovoltaic power generation L in the current month | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x0279` | 633 | Photovoltaic power generation H in the current year | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x027A` | 634 | Photovoltaic power generation L in the current year | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x027B` | 635 | Total power generation H of photovoltaic 1 | uint16_t | 10Wh | Read-only |  |
| ✅ |  | ✅ | `0x027C` | 636 | Photovoltaic 1 Total Power Generation L | uint16_t | 10Wh | Read-only |  |
| ✅ |  |  | `0x027D` | 637 |  |  |  |  |  |
| ✅ |  |  | `0x027E` | 638 |  |  |  |  |  |
| ✅ |  |  | `0x027F` | 639 |  |  |  |  |  |
...
| ✅ |  | ✅ | `0x0331` | 817 | INV temperature |  | ℃ | Read-only |  |
| ✅ |  | ✅ | `0x0332` | 818 | CHG temperature |  | ℃ | Read-only |  |
| ✅ |  | ✅ | `0x0333` | 819 | CHG2 temperature |  | ℃ | Read-only |  |
| ✅ |  | ✅ | `0x0334` | 820 | Ambient temperature |  | ℃ | Read-only |  |
|  |  | ✅ | `0x0335` | 821 | DIS_CHG temperature |  | ℃ | Read-only |  |
|  |  |  | `0x0336` | 822 |  |  |  |  |  |
|  |  |  | `0x0337` | 823 |  |  |  |  |  |
|  |  |  | `0x0338` | 824 |  |  |  |  |  |
|  |  |  | `0x0339` | 825 |  |  |  |  |  |
...
| ✅ |  | ✅ | `0x0321` | 801 | Fan status |  |  | Read-only | A non-zero value indicates a stalled turn. |
|  |  |  | `0x0322` | 802 |  |  |  |  |  |
|  |  |  | `0x0323` | 803 |  |  |  |  |  |
...
| ✅ |  |  | `0x4101` | 16641 | Output frequency | uint16_t | / | Reading and writing | 0:50Hz 1:60Hz |
| ✅ |  |  | `0x4102` | 16642 | Output priority | uint16_t | / | Reading and writing | 0:GPB 1:PGB 2:PBG 3:MKS |
| ✅ |  |  | `0x4103` | 16643 | Operating mode | uint16_t | / | Reading and writing | 0:APP 1:UPS |
| ✅ |  |  | `0x4104` | 16644 | Charging priority | uint16_t | / | Reading and writing | 0:PNG 1:OPV 2:PVF |
| ✅ |  |  | `0x4105` | 16645 | AC charging current | uint16_t | 1A | Reading and writing | 2-120A continuously adjustable [VMH6KU only supports 0x02:2A, 0x0A:10A, 0x14:20A, 0x1E:30A, 0x28:40A, 0x32:50A, 0x3C:60A, 0x46:... |
| ✅ |  |  | `0x4106` | 16646 | Maximum charging current | uint16_t | / | Reading and writing | 0:2A 1:10A 2:20A 3:30A 4:40A 5:50A 6:60A 7:70A 8:80A 9:90A 10:100A 11:110A 12:120A |
| ✅ |  |  | `0x4107` | 16647 | Battery Type | uint16_t | / | Reading and writing | 0: Lead-acid battery; 1: Water-filled battery; 2: Ternary lithium battery; 3: Lithium iron phosphate battery; 4: User-defined b... |
| ✅ |  |  | `0x4108` | 16648 | Battery low voltage point | uint16_t | 0.1V | Reading and writing | Lead-acid/Water-filled: 44V; Non-adjustable Ternary Lithium/Lithium Iron: 41.2V-50V; Customizable: 42V - 54V |
| ✅ |  |  | `0x4109` | 16649 | Battery low voltage point (battery shutdown point) | uint16_t | 0.1V | Reading and writing | Lead-acid/Water-filled: 42V Non-adjustable ternary lithium/lithium iron phosphate/Custom: 40V-48V |
| ✅ |  |  | `0x410A` | 16650 | constant pressure point | uint16_t | 0.1V | Reading and writing | Lead-acid: 56.4V; Non-adjustable water-filled: 58V; Non-adjustable ternary lithium/lithium iron phosphate/custom: 48V-60V |
| ✅ |  |  | `0x410B` | 16651 | float point | uint16_t | 0.1V | Reading and writing | Lead-acid/Water-filled: 54V; Non-adjustable Ternary Lithium/Lithium Iron: 50V-58V; Customizable: 48V-60V |
...
| ✅ |  |  | `0x410E` | 16654 | Low voltage point of mains power | uint16_t | 1V | Reading and writing | APP: 90V-154V UPS: 170V-200V |
| ✅ |  |  | `0x410F` | 16655 | High voltage point of mains power | uint16_t | 1V | Reading and writing | APP: 264V-280V UPS: 264V |
...
| ✅ |  |  | `0x4118` | 16664 | Dual-channel output cutoff voltage | uint16_t | 0.1V | Reading and writing | 440-600: 44V-60V |
| ✅ |  |  | `0x4119` | 16665 | Dual-channel output time | uint16_t | 1min | Reading and writing | 5-900: 5min-900min 0xFFF1: Dual output disabled 0xFFF2: Dual output unlimited time |
...
| ✅ |  |  | `0x411E` | 16670 | BMS Protocol Selection | uint16_t | / | Reading and writing | 0: Disable BMS function; 1: CVTE protocol; 2: Growatt protocol; 3: Sun & Moon protocol; 4: Power protocol; 5: Tower protocol; 6... |
| ✅ |  |  | `0x411F` | 16671 | BMS ID Selection | uint16_t | / | Reading and writing | 0-15 0xFFF1: ID self-search |
| ✅ |  |  | `0x4120` | 16672 | Low SOC shutdown SOC settings | uint16_t | 0.01 | Reading and writing | 5-50 0xFFF1: Low SOC shutdown function for disabled users |
| ✅ |  |  | `0x4121` | 16673 | Battery SOC settings | uint16_t | 0.01 | Reading and writing | 10-90 0xFFF1: Power-off SOC to Battery Function |
| ✅ |  |  | `0x4122` | 16674 | SOC settings for switching to AC power | uint16_t | 0.01 | Reading and writing | 10-100 0xFFF1: Disabled SOC to AC power function |
| ✅ |  |  | `0x4123` | 16675 | Remote power on/off enable | uint16_t | / | Reading and writing | 0: Disable remote control; 1: Enable remote control and power on; 2: Enable remote control and power off. |
| ✅ |  |  | `0x4124` | 16676 | Turn off charging | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4125` | 16677 | Self-extinguishing backlight | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4126` | 16678 | Reserved | / | / | Reading and writing | / |
| ✅ |  |  | `0x4127` | 16679 | Overheating restart | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4128` | 16680 | Overload restart | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4129` | 16681 | Overload bypass | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x412A` | 16682 | Low power consumption and energy saving | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x412B` | 16683 | Automatic detection of mains frequency | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x412C` | 16684 | After the output relay is closed, the inverter soft starter is activated. | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x412D` | 16685 | Battery open circuit warning | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x412E` | 16686 | Feeder Function Enable | uint16_t | / | Reading and writing | 0: OFF 1: INT internal sampling grid connection 2: CT external current transformer sampling grid connection 3: MET external met... |
| ✅ |  |  | `0x412F` | 16687 | Feeder power | uint16_t | 0.1KW | Reading and writing | 0-65:0-6.5KW |
| ✅ |  |  | `0x4130` | 16688 | Buzzer muted | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4131` | 16689 | Default return to main interface settings | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4132` | 16690 | Warning of main input change | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4133` | 16691 | Restore default settings | uint16_t | / | Reading and writing | 0:OFF 1:ON |
| ✅ |  |  | `0x4134` | 16692 | Seconds setting | uint16_t | 1 sec | Reading and writing | 0-59 |
| ✅ |  |  | `0x4135` | 16693 | point | uint16_t | 1min | Reading and writing | 0-59 |
| ✅ |  |  | `0x4136` | 16694 | hour | uint16_t | 1 hour | Reading and writing | 0-23 |
| ✅ |  |  | `0x4137` | 16695 | day | uint16_t | / | Reading and writing | 0-31 |
| ✅ |  |  | `0x4138` | 16696 | moon | uint16_t | / | Reading and writing | 0-12 |
| ✅ |  |  | `0x4139` | 16697 | Year | uint16_t | / | Reading and writing | 0-99 |
...
| ✅ |  |  | `0x4142` | 16706 | Maximum discharge current | uint16_t | A | Reading and writing | 0-30:10-160A (step size 5A) 0xFFF1: OFF [Effective for VMH5KU/VMH6KU and VML1K2; VMH5KU supports up to 160A, VMH6KU supports up... |
| ✅ |  |  | `0x4143` | 16707 | Wi-Fi connection status | uint16_t |  | Reading and writing | The following settings are used for the Wi-Fi module: 1: Wi-Fi not connected to a hotspot; 2: Wi-Fi connecting to a hotspot; 3:... |
...
*Всього регістрів: **1046** | Реалізовано сенсорів у YAML: **165***
